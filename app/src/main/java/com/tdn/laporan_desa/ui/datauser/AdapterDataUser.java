...
public class AdapterDataUser extends RecyclerView.Adapter<AdapterDataUser.MyViewHolder> {
    private List<UserObject> user = new ArrayList<>();
    private AdapterClicked listener;


    public AdapterDataUser(AdapterClicked listener) {
        ...
        if (this.user == null) {
            ...
            DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public int getOldListSize() {
                    return AdapterDataUser.this.user.size();
                }
                ...
                public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                    return AdapterDataUser.this.user.get(oldItemPosition).getIdUser() == l.get(newItemPosition).getIdUser();
                }
