...
public class AdapterConversation extends RecyclerView.Adapter<AdapterConversation.MyViewHolder> {
    ...
    private int VIEW_TIPE_TEXT = 1;
    private int VIEW_TIPE_IMAGE = 2;
    private int VIEW_TIPE_TEXTIMAGE = 3;


    public AdapterConversation(AdapterClicked listener) {
        ...
        if (this.user == null) {
            ...
            DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                    return AdapterConversation.this.user.get(oldItemPosition).getIdUser() == l.get(newItemPosition).getIdUser();
                }
