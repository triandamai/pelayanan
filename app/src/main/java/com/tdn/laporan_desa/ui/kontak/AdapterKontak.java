...
public class AdapterKontak extends RecyclerView.Adapter<AdapterKontak.MyViewHolder> {
    ...
    public AdapterKontak(AdapterClicked listener) {
        ...
        if (this.user == null) {
            ...
            DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public int getOldListSize() {
                    return AdapterKontak.this.user.size();
                }
                ...
                public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                    return AdapterKontak.this.user.get(oldItemPosition).getIdUser() == l.get(newItemPosition).getIdUser();
                }
